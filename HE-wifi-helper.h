...
#ifndef HE_WIFI_HELPER_H
#define HE_WIFI_HELPER_H
...
/**
 * \brief manage and create wifi channel objects for the HE model.
 *
 * The intent of this class is to make it easy to create a channel object
 * which implements the HE channel model. The HE channel model is described
 * in "Yet Another Network Simulator", http://cutebugs.net/files/wns2-HE.pdf
 */
class HEWifiChannelHelper
{
public:
  /**
   ...
   */
  static HEWifiChannelHelper Default (void);
   ...
   */
  Ptr<HEWifiChannel> Create (void) const;
  ...
  */
  int64_t AssignStreams (Ptr<HEWifiChannel> c, int64_t stream);
...
/**
 * \brief Make it easy to create and manage PHY objects for the HE model.
 *
 * The HE PHY model is described in "Yet Another Network Simulator",
 ...
 *
 */
class HEWifiPhyHelper : public WifiPhyHelper
{
public:
  /**
   ...
   */
  static HEWifiPhyHelper Default (void);
...
private:
  ...
  Ptr<HEWifiChannel> m_channel;
};

} //namespace ns3

#endif /* HE_WIFI_HELPER_H */
